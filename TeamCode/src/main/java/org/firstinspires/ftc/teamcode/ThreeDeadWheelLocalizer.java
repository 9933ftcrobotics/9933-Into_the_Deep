...
public final class ThreeDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double par0YTicks = -1181.3556901518766; // y position of the first parallel encoder (in tick units)
        public double par1YTicks = 985.8758299757374; // y position of the second parallel encoder (in tick units)
        public double perpXTicks = -1918.3989199949535; // x position of the perpendicular encoder (in tick units)
    }
