...
@Config
@Autonomous(name = "Official BLUE RIGHT Auto", group = "Autonomous")

public class OfficialBlueRightAuto extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        Pose2d finishScorePos = new Pose2d(-5, 36, Math.toRadians(-90));
        Pose2d pickSamplePos = new Pose2d(-8, 42, Math.toRadians(-90));
        Pose2d dispensePos = new Pose2d(-35, 25, Math.toRadians(180));
        ...
        TrajectoryActionBuilder Dispense = drive.actionBuilder(dispensePos)
                .strafeToSplineHeading(new Vector2d(-54, 47), Math.toRadians(90));
